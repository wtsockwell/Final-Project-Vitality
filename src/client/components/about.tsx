                            ...
                            <div className="row">
                                <div className="row-md-6 content centered">
                                    ...
                                    <p>
                                        ...
                                        common type of heart disease in the United States is <b>coronary artery disease </b> 
                                        (<b>CAD</b>), which affects the blood flow to the heart. Decreased blood flow can cause
                                        a heart attack.
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        experiences signs or symptoms of a <b>heart attack</b>, <b>heart failure</b>, or an 
                                        <b> arrhythmia</b>. When these events happen, symptoms may include:
                                    </p>

                                        <li>
                                        <b>Heart Attack</b>: Chest pain or discomfort, upper back or neck pain,
                                        indigestion, heartburn, nausea or vomiting, extreme fatigue, upper body
                                        discomfort, dizziness, and shortness of breath.
                                        </li>

                                        <li>
                                        <b>Arrhythmia</b>: Fluttering feeling in the chest (palpitations).
                                        </li>

                                        <li>
                                        <b>Heart Failure</b>: Shortness of breath, fatigue, or swelling of the feet,
                                    ...
                                    <p>
                                        ...
                                        for heart disease. About half of Americans (47%) have at least one of these
                                        three risk factors. Several other medical conditions and lifestyle choices can
                                        also put people at higher risk for heart disease, including:
                                    </p>
                                    ...
                                    <h1>How Does it Affect Men?</h1>
                                        ...
                                        <li>
                                        <b>Heart disease</b> is the leading cause of death for men of most racial and
                                        ethnic groups in the United States, including African Americans, American
                                        Indians or Alaska Natives, Hispanics, and whites. For Asian American or
                                        Pacific Islander men, heart disease is second only to cancer.
                                        </li>
                                        ...
                                        <li>
                                        Half of the men who die suddenly of coronary heart disease had no previous
                                        symptoms. Even if you have no symptoms, you may still be at risk for heart
                                        disease.
                                        </li>
                                    ...
                                    <p>
                                        ...
                                        <li>
                                            A health module to determine how at risk the user is of
                                            getting heart disease based on their health profile.
                                        </li>

                                        <li>
                                            Educational and motivational videos that talk about healthy
                                            habits, exercises, recipes and nutrition (Cardiac Rehabilitation).
                                        </li>

                                        <li>
                                            Hosting events to promote others to do more healthy
                                            activities.
                                        </li>

                                        <li>
                                            Look at the latest news and see what's going on with the
                                            website.
                                        </li>
                                </div>
                            </div>
