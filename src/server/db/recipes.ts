...
const post = async (title: string, ingredients: string, content: string, userid: string, description: string) => Query('INSERT INTO recipes(totle,ingredients,content,userid,description) VALUES(?,?,?,?,?)', [title, ingredients, content, userid, description])
